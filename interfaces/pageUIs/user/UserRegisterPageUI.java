...
public class UserRegisterPageUI {
	...
	public static final String INPUT_FIRSTNAME_TEXTBOX = "xpath=//input[@id='FirstName']";
	public static final String INPUT_LASTNAME_TEXTBOX = "xpath=//input[@id='LastName']";
	public static final String INPUT_EMAIL_TEXTBOX = "xpath=//input[@id='Email']";
	public static final String INPUT_PASSWORD_TEXTBOX = "xpath=//input[@id='Password']";
	public static final String INPUT_CONFIRM_PASSWORD_TEXTBOX = "xpath=//input[@id='ConfirmPassword']";
	public static final String REGISTER_SUCCESS_MESSAGE = "xpath=//div[@class='result']";
	public static final String ERROR_EXIST_MESSAGE = "xpath=//div[contains(@class,'message-error')]//li";
